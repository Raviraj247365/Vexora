                ...
                GlassContainer(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: VexoraSpacing.lg),
                      Text('Motion', style: VexoraTypography.heading2(VexoraColors.textPrimary)),
                      const SizedBox(height: VexoraSpacing.sm),
                      AnimatedContainer(
                        duration: VexoraAnimation.standard,
                        curve: VexoraAnimation.smooth,
                        padding: EdgeInsets.all(_expanded ? VexoraSpacing.xl : VexoraSpacing.md),
                        decoration: BoxDecoration(
                          color: VexoraColors.surfaceAlt,
                          borderRadius: BorderRadius.circular(_expanded ? 32 : 20),
                          border: Border.all(color: VexoraColors.accent.withOpacity(0.25)),
                        ),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Animated live card', style: VexoraTypography.bodyLarge(VexoraColors.textPrimary)),
                            const SizedBox(height: VexoraSpacing.sm),
                            Text(
